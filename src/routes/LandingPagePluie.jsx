const LandingPagePub = () => {
    return (
      <>
        ...
        <br />
        <h2>Choisir le velomobile par temps de pluie</h2>
        <br />
        <br />
        ...
        <div className="container" id="containerdesign">
          <p>
            <br />
            <br />
            <h3>Les 5 atouts sous la pluie : </h3>
            <br />
            <strong>
            ...
            <br />
            <br />
            <img id="vm1logo" src={`/images/velosmobiles/capote.jpg`} alt="" />
            <br />
            <br />
            <br />
            <strong>1-Protection complète:</strong> La capote du velomobile
            ...
            <br /> <br />
            <strong>2- Confort accru: </strong>Conduire un velomobile sous la
            ...
            <br />
            <br />
            <strong>3-Visibilité améliorée: </strong>La capote du velomobile est
            ...
            <br />
            <br />
            <strong>4-Stabilité et sécurité: </strong> La capote du velomobile
            ...
            <br />
            <br />
            <strong>5-Protection des bagages </strong> : En plus de protéger les
            ...
            <br />
            <br />
            <strong>En conclusion,</strong> la capote du velomobile constitue un
